    ...
    <div className="flex h-screen items-center justify-center ">
      <div className="bg-zinc-800 max-w-md p-5 rounded-md ">
        <form onSubmit={handleSubmit(onSubmit)}>
          <h1 className="text-4xl text-center text-white font-semibold bg-teal-700">
            Login
          </h1>
          ...
          <button
            type="submit"
            className="bg-teal-700  text-white px-4 py-2 rounded-md my-2"
          >
            Login
          </button>
        </form>
        ...
        <p className="flex justify-between px-4 py-2">
          ...
          <Link
            to="/register"
            className="px-3 font-semibold rounded-md text-white bg-pink-700"
          >
            Register
          </Link>
        </p>
